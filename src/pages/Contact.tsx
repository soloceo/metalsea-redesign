...
export default function Contact() {
  return (
    <MainLayout>
      <section className="pt-40 pb-20 bg-bg-body relative overflow-hidden">
        {/* Background Elements */}
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <motion.h1 
              ...
              className="text-5xl md:text-7xl font-display font-light text-text-primary mb-8 tracking-tight leading-tight"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
            ...
            <motion.div 
              ...
              className="glass-panel p-10 rounded-sm text-center group hover:bg-glass-highlight transition-colors duration-500"
            >
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 lg:gap-12 items-stretch glass-panel rounded-sm overflow-hidden">
               ...
               {/* Form (Right) - 8 cols */}
               <div className="lg:col-span-7 w-full p-8 md:p-12">
                  {/* Tabs */}
                  <div className="flex gap-8 mb-10 border-b border-glass-border">
                    <button className="pb-4 text-text-primary border-b border-text-primary font-mono text-xs uppercase tracking-widest font-bold">General Inquiry</button>
                    <button className="pb-4 text-text-muted hover:text-text-primary transition-colors font-mono text-xs uppercase tracking-widest">Partnership Application</button>
                  </div>
