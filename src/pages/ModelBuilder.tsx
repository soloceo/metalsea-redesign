...
export default function ModelBuilder() {
  return (
    <MainLayout>
      <section className="pt-32 pb-20 bg-bg-body min-h-screen flex flex-col justify-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <motion.div
            ...
            className="max-w-4xl mx-auto glass-panel p-16 rounded-sm border border-white/10"
          >
            <div className="w-24 h-24 bg-glass-bg rounded-full flex items-center justify-center mx-auto mb-10 text-text-primary border border-glass-border shadow-[0_0_30px_rgba(255,255,255,0.05)]">
            ...
            <p className="text-xl text-text-secondary mb-12 leading-relaxed font-light max-w-2xl mx-auto">
